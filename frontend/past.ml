...
let rec pp_expr ppf = function
  ...
  | Case (_, e, (x1, t1, e1), (x2, t2, e2)) ->
      fprintf ppf
        ...
        pp_expr e fstring x1 pp_type t1 pp_expr e1 fstring x2 pp_type t2
        pp_expr e2
  | Seq (_, []) -> ()
  | Seq (_, [e]) -> pp_expr ppf e
  | Seq (l, e :: rest) ->
      fprintf ppf "%a; %a" pp_expr e pp_expr (Seq (l, rest))
...
let rec string_of_expr = function
  ...
  | Inl (_, _t, e) -> mk_con "Inl" [string_of_expr e]
  | Inr (_, _t, e) -> mk_con "Inr" [string_of_expr e]
